    ...
    String urlBazaDate = "jdbc:mysql://localhost/taxi";
               ...
               <form action="Manager2.jsp">
                ...
                Statement s = c.createStatement(); 
                  String sum="SELECT SUM(Combustibil) FROM curse WHERE DataFactura='"+DataFactura+"'";
                ...
                while (rs.next()) { 
                    ...
                    out.println("Combustibil Consumat: " +Countrun+" litri, la data de "+DataFactura);
