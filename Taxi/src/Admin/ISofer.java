...
/**
 * Servlet implementation class ISofer
 */
@WebServlet("/ISofer")
public class ISofer extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String im = "insert into soferi"
					+ "(Id,Nume,Prenume,Cnp,SerieCi,NrCi,AnPermis,User,Password)" + "values('" + Id + "','" + Nume + "','" + Prenume + "','" + Cnp + "','" + SerieCi + "','" + NrCi + "','" + AnPermis + "','" + User + "','" + Password + "')";
			s.executeUpdate(im);
			s.close();
