...
/**
 * Servlet implementation class MCombustibil
 */
@WebServlet("/MCombustibil")
public class MCombustibil extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String mod="update combustibil set Nume='"+Nume+"',UnitateMasura='"+UnitateMasura+"',Cost='"+Cost+"' where Id='"+Id+"'";
			s.executeUpdate(mod);
