...
/**
 * Servlet implementation class ICombustibil
 */
@WebServlet("/ICombustibil")
public class ICombustibil extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String im = "insert into combustibil"
					+ "(Id,Nume,UnitateMasura,Cost)"
					+ "values('" + Id + "','" + Nume + "','" + UnitateMasura+ " ','" + Cost + " ')";
			s.executeUpdate(im);
			s.close();
